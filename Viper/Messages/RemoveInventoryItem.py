...
class RemoveInventoryItem(Message):

	absolute_id = 4294902030 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: RemoveInventoryItem, Message Absolute ID: 4294902030, Blocks: {self.AgentData},{self.InventoryData}"""
