...
class RequestTaskInventory(Message):
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: RequestTaskInventory, Message Absolute ID: 4294902049, Blocks: {self.AgentData},{self.InventoryData}"""
	...
	def convert_to_bytes(self) -> bytes:
		...
		output = output + BytesUtils.pack_bytes_little_endian(["unsigned int32",],self.InventoryData.LocalID)
