...
class EstateOwnerMessage(Message):

	absolute_id = 4294902020 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: EstateOwnerMessage, Message Absolute ID: 4294902020, Blocks: {self.AgentData},{self.MethodData},{self.ParamList}"""
