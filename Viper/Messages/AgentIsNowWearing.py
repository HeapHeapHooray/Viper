...
class AgentIsNowWearing(Message):
...
{self.WearableData}"""
	...
	def convert_to_bytes(self) -> bytes:
		...
		for i in range(blocks_count):
			output = output + BytesUtils.pack_bytes_little_endian(["uuid","unsigned byte",],self.WearableData[i].ItemID,self.WearableData[i].WearableType)
