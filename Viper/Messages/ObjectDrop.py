...
class ObjectDrop(Message):

	absolute_id = 4294901874 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: ObjectDrop, Message Absolute ID: 4294901874, Blocks: {self.AgentData},{self.ObjectData}"""
