...
class BulkUpdateInventory(Message):
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: BulkUpdateInventory, Message Absolute ID: 4294902041, Blocks: {self.AgentData},{self.FolderData},{self.ItemData}"""

	def convert_to_bytes(self) -> bytes:
		output = b""

		output = output + BytesUtils.pack_bytes_little_endian(["uuid","uuid",],self.AgentData.AgentID,self.AgentData.TransactionID)
