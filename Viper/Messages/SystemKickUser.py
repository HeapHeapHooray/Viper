...
class SystemKickUser(Message):

	absolute_id = 4294901926 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: SystemKickUser, Message Absolute ID: 4294901926, Blocks: {self.AgentInfo}"""
