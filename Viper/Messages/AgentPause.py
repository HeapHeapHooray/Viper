...
class AgentPause(Message):

	absolute_id = 4294901838 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: AgentPause, Message Absolute ID: 4294901838, Blocks: {self.AgentData}"""
