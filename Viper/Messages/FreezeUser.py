...
class FreezeUser(Message):

	absolute_id = 4294901928 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: FreezeUser, Message Absolute ID: 4294901928, Blocks: {self.AgentData},{self.Data}"""
