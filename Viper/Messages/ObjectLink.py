...
class ObjectLink(Message):

	absolute_id = 4294901875 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: ObjectLink, Message Absolute ID: 4294901875, Blocks: {self.AgentData},{self.ObjectData}"""
