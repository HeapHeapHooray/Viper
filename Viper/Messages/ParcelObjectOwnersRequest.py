...
class ParcelObjectOwnersRequest(Message):

	absolute_id = 4294901816 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: ParcelObjectOwnersRequest, Message Absolute ID: 4294901816, Blocks: {self.AgentData},{self.ParcelData}"""
