...
class ParcelGodMarkAsContent(Message):

	absolute_id = 4294901987 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: ParcelGodMarkAsContent, Message Absolute ID: 4294901987, Blocks: {self.AgentData},{self.ParcelData}"""
