...
{self.AgentData}"""
	...
	def convert_to_bytes(self) -> bytes:
		...
		output = output + BytesUtils.pack_bytes_little_endian(["uuid","uuid","unsigned byte",],self.AgentData.AgentID,self.AgentData.SessionID,self.AgentData.AlwaysRun)
