...
{self.DataBlock}"""
	...
	def convert_to_bytes(self) -> bytes:
		...
		for i in range(blocks_count):
			output = output + BytesUtils.pack_bytes_little_endian(["unsigned int64","signed byte","variable2",],self.DataBlock[i].Hash,self.DataBlock[i].RequestType,self.DataBlock[i].Request)
