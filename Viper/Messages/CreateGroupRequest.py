...
class CreateGroupRequest(Message):
	...
	absolute_id = 4294902099 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: CreateGroupRequest, Message Absolute ID: 4294902099, Blocks: {self.AgentData},{self.GroupData}"""
