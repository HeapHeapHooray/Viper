...
class CompleteAuction(Message):

	absolute_id = 4294901991 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: CompleteAuction, Message Absolute ID: 4294901991, Blocks: {self.ParcelData}"""
