...
class ObjectDelete(Message):
	...
	absolute_id = 4294901849 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: ObjectDelete, Message Absolute ID: 4294901849, Blocks: {self.AgentData},{self.ObjectData}"""

	def convert_to_bytes(self) -> bytes:
		output = b""

		output = output + BytesUtils.pack_bytes_little_endian(["uuid","uuid","unsigned byte",],self.AgentData.AgentID,self.AgentData.SessionID,self.AgentData.Force)
