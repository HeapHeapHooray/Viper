...
class CancelAuction(Message):

	absolute_id = 4294901992 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: CancelAuction, Message Absolute ID: 4294901992, Blocks: {self.ParcelData}"""
