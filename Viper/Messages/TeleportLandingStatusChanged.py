...
class TeleportLandingStatusChanged(Message):

	absolute_id = 4294901907 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: TeleportLandingStatusChanged, Message Absolute ID: 4294901907, Blocks: {self.RegionData}"""
