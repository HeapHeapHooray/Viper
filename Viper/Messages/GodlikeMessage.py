...
class GodlikeMessage(Message):

	absolute_id = 4294902019 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: GodlikeMessage, Message Absolute ID: 4294902019, Blocks: {self.AgentData},{self.MethodData},{self.ParamList}"""
