...
class AvatarPicksReply(Message):

	absolute_id = 4294901938 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: AvatarPicksReply, Message Absolute ID: 4294901938, Blocks: {self.AgentData},{self.Data}"""
	...
	def convert_to_bytes(self) -> bytes:
		...
		for i in range(blocks_count):
			output = output + BytesUtils.pack_bytes_little_endian(["uuid","variable1",],self.Data[i].PickID,self.Data[i].PickName)
