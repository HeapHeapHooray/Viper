...
class UseCircuitCode(Message):
    ...
    def __init__(self,bytes_data: bytes):
        ...
        if bytes_data is None:
            return
        result = BytesUtils.unpack_bytes_little_endian(["unsigned int32","uuid","uuid"],bytes_data)
    ...
    def convert_to_bytes(self) -> bytes:
        return BytesUtils.pack_bytes_little_endian(["unsigned int32","uuid","uuid"],self.circuit_code,self.session_uuid,self.agent_uuid)
