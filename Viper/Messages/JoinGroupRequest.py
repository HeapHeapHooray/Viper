...
class JoinGroupRequest(Message):
	...
	absolute_id = 4294902103 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: JoinGroupRequest, Message Absolute ID: 4294902103, Blocks: {self.AgentData},{self.GroupData}"""
