...
class RegionPresenceRequestByRegionID(Message):
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: RegionPresenceRequestByRegionID, Message Absolute ID: 4294901774, Blocks: {self.RegionData}"""
	...
	def convert_to_bytes(self) -> bytes:
		...
		for i in range(blocks_count):
			output = output + BytesUtils.pack_bytes_little_endian(["uuid",],self.RegionData[i].RegionID)
