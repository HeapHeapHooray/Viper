...
class LogoutReply(Message):

	absolute_id = 4294902013 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: LogoutReply, Message Absolute ID: 4294902013, Blocks: {self.AgentData},{self.InventoryData}"""
