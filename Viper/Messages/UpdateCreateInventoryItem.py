...
class UpdateCreateInventoryItem(Message):
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: UpdateCreateInventoryItem, Message Absolute ID: 4294902027, Blocks: {self.AgentData},{self.InventoryData}"""

	def convert_to_bytes(self) -> bytes:
		output = b""

		output = output + BytesUtils.pack_bytes_little_endian(["uuid","unsigned byte","uuid",],self.AgentData.AgentID,self.AgentData.SimApproved,self.AgentData.TransactionID)
