...
class ObjectDelink(Message):

	absolute_id = 4294901876 # -- The Full ID of the message
	...
	def convert_to_string(self) -> str:
		return f"""Message Type: ObjectDelink, Message Absolute ID: 4294901876, Blocks: {self.AgentData},{self.ObjectData}"""
